...
// AK_CHINOOK_TODO: have a separate AkTypes.h for Chinook
// and include it directly in AK/AkPlatforms.h.
...
#define AK_COMM_DISABLE_ON_SUSPEND		///< Platform requires that networking resources be cleaned up on suspend

...
USTRUCT()
struct FAkXboxOneAnvilAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
...
USTRUCT()
struct FAkXboxOneAnvilApuHeapInitializationSettings
{
	GENERATED_USTRUCT_BODY()
...
class AKAUDIO_API UAkXboxOneAnvilInitializationSettings : public UObject
{
...
public:
	...
	FAkXboxOneAnvilApuHeapInitializationSettings ApuHeapSettings;

	UPROPERTY(Config, EditAnywhere, Category = "Initialization")
	FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;

	UPROPERTY(Config, EditAnywhere, Category = "Initialization", AdvancedDisplay)
	FAkXboxOneAnvilAdvancedInitializationSettings AdvancedSettings;
